...
ui=fluidPage(
  ...
  fluidRow(
    HTML("<br/><br/>"),
    column(2, textInput("caption", "Rechercher un vin : ", "henriot"),offset = 0.5),
    column(4, h5(tags$b("Vin tiré au hasard correspondant aux critères : ")),h5(em(textOutput("thew"))),offset = 0)
  ),
    fluidRow(
    column(1, actionButton(inputId="go",label="Submit",style="color: #fff; background-color: #337ab7; border-color: #2e6da4"),offset=0),
